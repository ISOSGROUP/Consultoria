...
<body>
  ...
  <input type="hidden" id="upload_files" value="<?php echo Config::get('permissionlist.upload_files'); ?>">
  <input type="hidden" id="download_files" value="<?php echo Config::get('permissionlist.download_files'); ?>">
  <input type="hidden" id="create_folders" value="<?php echo Config::get('permissionlist.create_folders'); ?>">
